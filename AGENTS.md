# Data Learn — project guide for Codex
...
- [`mcp-server/README.md`](./mcp-server/README.md) — MCP install, Codex Desktop config, per-tool data formats. Source-of-truth for the AI-authoring contract.
