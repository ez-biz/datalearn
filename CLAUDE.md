...
- [`docs/DEPLOY.md`](./docs/DEPLOY.md) — first-time Vercel + Supabase setup runbook, env-var matrix, migration + seed flow, admin bootstrap, health check, day-to-day workflow.
